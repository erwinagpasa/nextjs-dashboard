...
export const Navbar = () => {
  return ( 
    <div className="fixed w-full flex items-center justify-between h-14 z-10">
        ...
        <div className="flex items-center justify-start pl-3 w-14 md:w-64 h-14 bg-gray-200 border-none">
        ...
        <div className="flex justify-between items-center h-14 bg-gray-200 header-right">
