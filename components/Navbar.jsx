...
export const Navbar = () => {
  return ( 
    <div className="fixed w-full flex items-center justify-between h-14 z-10">       
      ...
      <div className="pl-4 flex justify-between items-center h-14 bg-slate-100 header-right">
        <div className="bg-white rounded flex items-center w-full max-w-xl mr-4 p-2 border border-gray-200">
        ...
        <ul className="flex items-center">
          ...
          <li><div className="block w-px h-6 mx-3 bg-gray-400"></div></li>
          <li>
