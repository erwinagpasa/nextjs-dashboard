...
export const Sidebar = () => {
  ...
  return ( 
    <div className="fixed flex flex-col top-14 left-0 w-14 hover:w-64 md:w-64 bg-gray-100 h-full transition-all duration-300 border-none z-10 sidebar">
        <div className="overflow-y-auto overflow-x-hidden flex flex-col justify-between flex-grow">
          <ul className="flex flex-col py-4 space-y-1">
            ...
            <li>
              <Link href="/" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-blue-800 border-l-4 border-transparent hover:border-blue-500 pr-6">
        ...
        <div className="overflow-hidden group relative rounded-lg flex justify-center items-center">
          <Link className="block w-full relative z-10 rounded-lg bg-white sm:p-6" href="/">
